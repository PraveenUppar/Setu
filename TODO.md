...
- **S4 partial:** engine complete; **24 of the 37 numbered subsections** built, as 43 registry sections. Wave 1 extraction and every Wave 2 computed section are done — what remains is narrative (S9/S10), the AoA (S7), boilerplate stragglers inside built sections, or external.
